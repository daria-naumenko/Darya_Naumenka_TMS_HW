...
//Login, Password, confirmPassword. Все поля имеют тип данных String.
...
public class Main {
    public static void main(String[] args) throws WrongLoginException, WrongPasswordException {
        ...
        Registration.loginMethod(scanner.nextLine());
        System.out.println("Введите и подтвердите пароль ");
        System.out.println(Registration.passwordMethod(scanner.nextLine(), scanner.nextLine()));
    }
}